...
mod tests {
    ...
    use array_lib::ArrayDim;
    use rand::{Rng};
    use crate::{compute_glcm, compute_symmetrical, l_inf_ball2, n_neighbors};
    ...
    fn textbook_symm() {
        ...
        assert_eq!(&glcm_symm,&expected_symm_glcm);
...
/// symmetrical GLCM from asymmetrical GLCM (S = A^T + A)
