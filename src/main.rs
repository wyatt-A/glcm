...
// use clap::Parser;
// use glcm::ui::{GLCMFeature, GLCMFeatureIter, MapOpts, RadMapOptsSer};
// use eframe;
...
//                 x.into()
//             })
//                 .unwrap_or_else(MapOpts::default)
//         });
// 
...
// 
// 
// fn feature_selector(opts:&mut MapOpts, ui: &mut egui::Ui) {
...
// }
// 
// fn run_map(opts: MapOpts, image:Vec<f64>, mask:Option<Vec<f64>>, dims:ArrayDim, progress:Arc<AtomicUsize>) -> (Vec<f64>, ArrayDim) {
// 
